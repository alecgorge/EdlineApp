...
static void *RefreshBlockKey;

@implementation UITableViewController (SVPullToRefresh)
...
forControlEvents:UIControlEventValueChanged];
	...
	objc_setAssociatedObject(self, &RefreshBlockKey, actionHandler, OBJC_ASSOCIATION_COPY_NONATOMIC);
...
- (void)refresh:(id)sender {
	[self startAnimating];
	((void(^)(void))objc_getAssociatedObject(self, &RefreshBlockKey))();
...
- (void)startAnimating {
    ...
    if (self.tableView.contentOffset.y == 0) {
        [UIView animateWithDuration:0.25
							  delay:0
							options:UIViewAnimationOptionBeginFromCurrentState animations:^(void){
